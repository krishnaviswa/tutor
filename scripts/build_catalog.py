...
CONTRACTS: dict[str, dict] = {
    ...
    "parent-home": {
        ...
        "ports": [],
        "timelineEvents": [],
        "shows": "Guardian hub for linked children only: attendance fraction, latest practice, latest test, fee due date, activity, marksheet, receipts, teacher chat.",
    },
    "schedule": {
    ...
    "library": {
        ...
        "ports": ["storage"],
        "timelineEvents": [],
        "shows": "Lessons with kind, duration, and progress. Visibility per cohort.",
    },
    "lesson": {
    ...
    "owner": {
        ...
        "ports": [],
        "timelineEvents": [],
        "shows": "Operating scorecard (sessions, students, practice %, SLA, revenue, churn) plus quota bars (80% / 100%). Feature kill switches.",
    },
    "reports": {
